...
const ISLAND: IslandScope = 'saint_catalina';
...
export default async function SaintCatalinaPage({ params, searchParams }: PageProps) {
  ...
  return (
    <IslandPageContent
      ...
      locale={locale}
      dict={dict}
      basePath={localizedPath(locale, '/saint-catalina')}
