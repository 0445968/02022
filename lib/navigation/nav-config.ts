...
export function getPrimaryNav(dict: Dictionary, locale: Locale): NavItem[] {
  return [
    ...
    { key: 'world', label: dict.nav.world, href: localizedPath(locale, '/category/world') },
    { key: 'community', label: dict.nav.community, href: localizedPath(locale, '/category/community') },
    { key: 'education', label: dict.nav.education, href: localizedPath(locale, '/category/education') },
    { key: 'entertainment', label: dict.nav.entertainment, href: localizedPath(locale, '/category/entertainment') },
    { key: 'travel', label: dict.nav.travel, href: localizedPath(locale, '/category/travel') },
    { key: 'tourism', label: dict.nav.tourism, href: localizedPath(locale, '/category/tourism') },
    { key: 'wellness', label: dict.nav.wellness, href: localizedPath(locale, '/category/wellness') },
    { key: 'events', label: dict.nav.events, href: localizedPath(locale, '/category/events') },
